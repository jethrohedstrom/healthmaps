  ...
  psychiatrist: {
    ...
    approachable: {
      ...
      qa: [
        ...
        {
          q: "Do I need a referral?",
          a: "Not to be seen — you can book a private psychiatrist without one. A GP referral only gets you the Medicare rebate; without it you pay the full fee, but there's also no Medicare record of the visit, which some people prefer for privacy."
        },
        {
          q: "How long's the wait?",
